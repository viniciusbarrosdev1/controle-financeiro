...
1. Instale a extensão **PHP Debug** (xdebug.php-debug).
2. Crie o arquivo `.vscode/launch.json` com o conteúdo abaixo:
...
3. Pressione **F5** e selecione **Listen for Xdebug**.
4. Coloque um breakpoint e acesse a aplicação no navegador — a execução vai parar
   no ponto marcado.
